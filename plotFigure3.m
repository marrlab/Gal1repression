...
for  irep = 1:2
    ...
    for icell = 1
        ...
        %model do
        if irep == 1
            plot((1-1)*3/60:3/60:(40-1)*3/60,NonDividing{istrain}.I5r1(ind_rand(icell),1:40)./1e7,':','Color','k')
            hold on
        else
            plot((1-1)*3/60:3/60:(40-1)*3/60,NonDividing{istrain}.I5r2(ind_rand(icell),1:40)./1e7,':','Color','k')
            hold on
        end
